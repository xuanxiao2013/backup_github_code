...
import {ArticleState, ArticleRecord, convertToRecordMap } from '../constants/Types';
import {ArticleListState} from '../constants/Types';
...
// checkout ArticleListReducer.js#ADD_TO_CART_REQUEST() for example on optimistic update example
...
export default createReducer( new ArticleState(), handlers );
